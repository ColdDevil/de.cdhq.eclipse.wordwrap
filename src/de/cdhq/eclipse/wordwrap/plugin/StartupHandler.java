 ...
 * 
 * I know that using the org.eclipse.ui.startup extension point is not recommended as it breaks the lazy-loading principle of plugins.
 * Unfortunately I cannot provide an alternative solution yet so consider this as a workaround. ;-)
 * 
...
public class StartupHandler implements IStartup {
    ...
    public void earlyStartup() {
         ...
         * returns null if it is called outside of the UI thread." [1]
         * 
         * [1] http://www.eclipse.org/forums/index.php/t/206897/
         */
